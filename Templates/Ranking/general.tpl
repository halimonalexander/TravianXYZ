...
$tribe1 = $database->query("SELECT * FROM ".TB_PREFIX."users WHERE tribe = 1");
$tribe2 = $database->query("SELECT * FROM ".TB_PREFIX."users WHERE tribe = 2");
$tribe3 = $database->query("SELECT * FROM ".TB_PREFIX."users WHERE tribe = 3");
$tribes = [
    $database->numRows($tribe1),
    $database->numRows($tribe2),
    $database->numRows($tribe3),
];
$users = $database->numRows($database->query("SELECT * FROM " . TB_PREFIX . "users WHERE tribe!=0 AND tribe!=4 AND tribe!=5"));
?>
    ...
    <table cellpadding="1" cellspacing="1" id="world_player" class="world">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php
                   $active = $database->numRows($database->query("SELECT * FROM ".TB_PREFIX."users WHERE ".time()."-timestamp < (3600*24) AND tribe!=0 AND tribe!=4 AND tribe!=5"));
                   echo $active; ?></td>
            </tr>
