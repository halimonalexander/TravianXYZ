...
echo "{\"lm\":\"<div id=\\\"mbig\\\"><div id=\\\"lightframe\\\"><div id=\\\"darkframe\\\"><a id=\\\"map_popclose\\\" href=\\\"" . \App\Routes::MAP . "?z=2356\\\"><img src=\\\"img\\/x.gif\\\" alt=\\\"close map\\\" title=\\\"close map\\\" \\/><\\/a><h1>Map(<span id=\\\"x\\\">";
echo $x;
echo "<\\/span>|<span id=\\\"y\\\">";
echo $y;
...
$coorindex = 0;
for($i=0;$i<=12;$i++) {
	echo "<area id=\\\"a_".$row."_".$i."\\\" shape=\\\"poly\\\" coords=\\\"".$coorarray[$coorindex]."\\\" title=\\\"".$maparray[$coorindex]['name']."\\\" href=\\\"" . \App\Routes::MAP . "?d=".$maparray[$coorindex]['id']."&c=".$generator->getMapCheck($maparray[$coorindex]['id'])."\\\" \\/>";
	if($i == 12 && $row <= 11) {
		$row += 1;
		$i = -1;
	}
