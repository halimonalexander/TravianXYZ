...
<body class="v35 ie ie7" onload="initCounter()">
    <div class="wrapper">
        ...
        <div id="mid">
            <?php include("Templates/loggedOutMenu.php")?>
                            ...
                            <tr class="top">
                                ...
                                <td>
                                    <input
                                        ...
                                        type="text"
                                        name="user"
                                        value="<?php echo stripslashes(stripslashes(stripslashes($form->getDiff("user",$_COOKIE['COOKUSR'])))); ?>"
                                        maxlength="30"
                                        autocomplete='off'
                                    />
                            ...
                            <tr class="btm">
                                ...
                                <td>
                                    <input
                                        ...
                                        type="password"
                                        name="pw"
                                        value="<?php echo $form->getValue("pw");?>"
                                        maxlength="100"
                                        autocomplete='off'
                                    />
