<?php
$units = $this->database->getMovement(3,$village->wid,0);
...
$isoasis = $this->database->isVillageOases($units[$y]['to']);
if ($isoasis ==0){ 	
$to = $this->database->getMInfo($units[$y]['to']);
} else {
$to = $this->database->getOMInfo($units[$y]['to']);}
?>
 ...
 <tr><th><?php echo TROOPS;?></th>
		...
		<tbody class="infos">
			<tr>
				...
				?>
                    <div class="abort"><a href="<?=\App\Routes::BUILD?>?id=<?php echo $_GET['id']."&mode=troops&cancel=1&moveid=".$units[$y]['moveid']; ?>"><img src="img/x.gif" class="del" /></a></div>
					<?php } ?>
					</div>
				</td>
			</tr>
 ...
 <tr><th><?php echo TROOPS;?></th>
        ...
        <tbody class="infos">
            <tr>
				...
				?>
                    <div class="abort"><a href="<?=\App\Routes::BUILD?>?id=<?php echo $_GET['id']."&mode=troops&cancel=1&moveid=".$settlers[$y]['moveid']; ?>"><img src="img/x.gif" class="del" /></a></div>
					<?php } ?>
                    </div>
                </td>
            </tr>
