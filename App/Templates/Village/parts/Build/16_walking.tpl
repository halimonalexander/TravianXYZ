    ...
    <tr>
      ...
      <td colspan="<?php if ($units[ $y ]['t11'] == 0) {
          ...
          if (($units[ $y ]['starttime'] + 90) > time()) {
              ?>
            <div class="abort"><a
                      href="<?=\App\Routes::BUILD?>?id=<?php echo $_GET['id'] . "&mode=troops&cancel=1&moveid=" . $units[ $y ]['moveid']; ?>"><img
                        src="/img/x.gif" class="del"/></a></div>
          <?php } ?>
        </div>
      </td>
    </tr>
        ...
        <tr>
          ...
          <td colspan="<?php if ($units[ $y ]['t11'] == 0) {
              ...
              if (($settlers[ $y ]['starttime'] + 90) > time()) { ?>
                <div class="abort">
                  <a href="<?=\App\Routes::BUILD?>?id=<?php echo $_GET['id'] . "&mode=troops&cancel=1&moveid=" . $settlers[ $y ]['moveid']; ?>">
