...
?>
    <td class="res">
        <img class="r1" src="/img/x.gif" alt="Lumber" title="Lumber" /><?php echo $uprequire['wood']; ?> |
        <img class="r2" src="/img/x.gif" alt="Clay" title="Clay" /><?php echo $uprequire['clay']; ?> |
        <img class="r3" src="/img/x.gif" alt="Iron" title="Iron" /><?php echo $uprequire['iron']; ?> |
        <img class="r4" src="/img/x.gif" alt="Crop" title="Crop" /><?php echo $uprequire['crop']; ?> |
        <img class="r5" src="/img/x.gif" alt="Crop consumption" title="Crop consumption" /><?php echo $uprequire['pop']; ?> |
        <img class="clock" src="/img/x.gif" alt="duration" title="duration" /><?php echo \App\Helpers\DatetimeHelper::secondsToTime($uprequire['time'])?>
        ...
        if($bindicator == 2) {
              ...
              if ($session->goldclub == 1) {
                ...
                <?php
                  if ($session->gold >= 1 && $village->master == 0) {
                      echo "<a class=\"build\" href=\"".\App\Routes::DORF2."?master=$bid&id=$id&time=$mastertime&c=$session->checker\">Constructing with master builder </a>";
            ...
            echo "<span class=\"none\">Upgrade Granary.</span>";
              ...
              if ($session->access!=BANNED) {
                   echo "<a class=\"build\" href=\"".\App\Routes::DORF2."?a=$bid&id=$id&c=".$session->checker."\">Construct building.</a>";
              } else {
                    echo ">Construct building.</a>";
              }
        } elseif($bindicator == 9) {
              if($session->access!=BANNED){
                   echo "<a class=\"build\" href=\"".\App\Routes::DORF2."?a=$bid&id=$id&c=".$session->checker."\">Construct building. (waiting loop)</a>";
              } else {
