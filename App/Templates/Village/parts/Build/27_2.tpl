...
?>
        ...
        if($this->database->numRows($this->database->query("SELECT * FROM " . TB_PREFIX . "artefacts")) == 0) {
        	...
        	$artefact = $this->database->query("SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 1");
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = $this->database->query("SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 2");
        	while($row = $this->database->fetchArray($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = $this->database->query("SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 3");
        	while($row = $this->database->fetchArray($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = $this->database->query("SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 4");
        	while($row = $this->database->fetchArray($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = $this->database->query("SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 5");
        	while($row = $this->database->fetchArray($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = $this->database->query("SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 6");
        	while($row = $this->database->fetchArray($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = $this->database->query("SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 7");
        	while($row = $this->database->fetchArray($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
...
?>
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = $this->database->query("SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 2 AND type = 8");
        	while($row = $this->database->fetchArray($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
        	...
        	unset($artefact);
        	unset($row);
        	$artefact = $this->database->query("SELECT * FROM `" . TB_PREFIX . "artefacts` WHERE size = 1 AND type = 8");
        	while($row = $this->database->fetchArray($artefact)) {
        		echo '<tr>';
        		echo '<td class="icon"><img class="artefact_icon_' . $row['type'] . '" src="img/x.gif" alt="" title=""></td>';
        		echo '<td class="nam">';
