<?php
$normalA = $this->database->getOwnArtefactInfoByType($village->wid,6);
$largeA = $this->database->getOwnUniqueArtefactInfo($session->uid,6,2);
...
$mainbuilding1 = $this->database->getBuildingByType2($village->wid,15);
$cranny1 = $this->database->getBuildingByType2($village->wid,23);
$granary1 = $this->database->getBuildingByType2($village->wid,11);
$warehouse1 = $this->database->getBuildingByType2($village->wid,10);
$embassy1 = $this->database->getBuildingByType2($village->wid,18);
$wall1 = $this->database->getBuildingByField2($village->wid,40);
$rallypoint1 = $this->database->getBuildingByType2($village->wid,16);
$hero1 = $this->database->getBuildingByType2($village->wid,37);
$market1 = $this->database->getBuildingByType2($village->wid,17);
$barrack1 = $this->database->getBuildingByType2($village->wid,19);
$cropland1 = $this->database->getBuildingByType2($village->wid,4);
$grainmill1 = $this->database->getBuildingByType2($village->wid,8);
$residence1 = $this->database->getBuildingByType2($village->wid,25);
$academy1 = $this->database->getBuildingByType2($village->wid,22);
$armoury1 = $this->database->getBuildingByType2($village->wid,13);
$woodcutter1 = $this->database->getBuildingByType2($village->wid,1);
$palace1 = $this->database->getBuildingByType2($village->wid,26);
$claypit1 = $this->database->getBuildingByType2($village->wid,2);
$ironmine1 = $this->database->getBuildingByType2($village->wid,3);
$blacksmith1 = $this->database->getBuildingByType2($village->wid,12);
$stable1 = $this->database->getBuildingByType2($village->wid,20);
$trapper1 = $this->database->getBuildingByType2($village->wid,36);
$treasury1 = $this->database->getBuildingByType2($village->wid,27);
$sawmill1 = $this->database->getBuildingByType2($village->wid,5);
$brickyard1 = $this->database->getBuildingByType2($village->wid,6);
$ironfoundry1 = $this->database->getBuildingByType2($village->wid,7);
$workshop1 = $this->database->getBuildingByType2($village->wid,21);
$stonemasonslodge1 = $this->database->getBuildingByType2($village->wid,34);
$townhall1 = $this->database->getBuildingByType2($village->wid,24);
$tournamentsquare1 = $this->database->getBuildingByType2($village->wid,14);
$bakery1 = $this->database->getBuildingByType2($village->wid,9);
$tradeoffice1 = $this->database->getBuildingByType2($village->wid,28);
$greatbarracks1 = $this->database->getBuildingByType2($village->wid,29);
$greatstable1 = $this->database->getBuildingByType2($village->wid,30);
$brewery1 = $this->database->getBuildingByType2($village->wid,35);
$horsedrinkingtrough1 = $this->database->getBuildingByType2($village->wid,41);
$herosmansion1 = $this->database->getBuildingByType2($village->wid,37);
$greatwarehouse1 = $this->database->getBuildingByType2($village->wid,38);
$greatgranary1 = $this->database->getBuildingByType2($village->wid,39);
$greatworkshop1 = $this->database->getBuildingByType2($village->wid,42);
?>
...
$query = $this->database->query("SELECT * FROM ".TB_PREFIX."vdata WHERE owner = ".$user."");
while($villaggi_array = $this->database->fetchArray($query)){

        //loop structure village
        $query1 = $this->database->query("SELECT * FROM ".TB_PREFIX."fdata WHERE vref = ".$villaggi_array['wref']."");
        $strutture= $this->database->fetchArray($query1);
