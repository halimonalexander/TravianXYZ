...
$wwbuildingplan = 0;
$villages = $this->database->getVillagesID($session->uid);
...
$alli_users = $this->database->getUserByAlliance($session->alliance);
