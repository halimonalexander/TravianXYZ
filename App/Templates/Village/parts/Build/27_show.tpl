...
$artefact = $this->database->getArtefactDetails($_GET['show']);
...
<td>
<a href="spieler.php?uid=<?php echo $artefact['owner'];?>"><?php echo $this->database->getUserField($artefact['owner'],"username",0);?></a>
</td>
</tr>
<tr>
...
<td><a href="allianz.php?aid=<?php echo $this->database->getUserField($artefact['owner'],"alliance",0);?>"><?php echo $this->database->getAllianceName($this->database->getUserField($artefact['owner'],"alliance",0)); ?></a></td>
</tr>
<tr>
