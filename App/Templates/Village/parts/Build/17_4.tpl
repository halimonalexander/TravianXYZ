...
<?php
$routes = $this->database->getTradeRoute($session->uid);
    if(count($routes) == 0) {
...
<th>
   ...
   <a href="<?=\App\Routes::BUILD?>?action=extendRoute&routeid=<?php echo $routeid; ?>"><?php echo EXTEND;?></a>*
 | <a href="<?=\App\Routes::BUILD?>?id=<?php echo $id; ?>&t=4&action=editRoute&routeid=<?php echo $routeid; ?>"><?php echo EDIT;?></a>
 | <a href="<?=\App\Routes::BUILD?>?action=delRoute&routeid=<?php echo $routeid; ?>"><?php echo DELETE;?></a>
	</th></tr></tfoot></table>
		* <?php echo EXTEND_TRADE_ROUTES;?> <img src="../../<?php echo GP_LOCATE; ?>img/a/gold.gif" alt="Gold" title="<?php echo GOLD;?>">2
<br>
<div class="options">
    <a class="arrow" href="<?=\App\Routes::BUILD?>?gid=17&t=4&create">» <?php echo CREATE_TRADE_ROUTES;?></a>
</div>
	</div>
<?php
}}else{
