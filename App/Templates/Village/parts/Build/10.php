<?php
include("next.php");
$bid =\App\Helpers\GlobalVariablesHelper::getBuilding(10);
?>
...
<p class="build_desc"><?php echo WAREHOUSE_DESC; ?></p>
	...
	<tr>
		...
		<td><b><?php echo $bid[$village->resarray['f'.$id]]['attri']*STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?></td>
	</tr>
	<tr>
<?php 
    if(!$building->isMax($village->resarray['f'.$id.'t'],$id)) {
		...
		if ($next<=20) { ?>
            ...
            <td><b><?php echo $bid[$next]['attri']*STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?></td>
        <?php } else { ?>
            <th><?php echo CAPACITY_LEVEL; ?> 20:</th>
            <td><b><?php echo $bid[20]['attri']*STORAGE_MULTIPLIER; ?></b> <?php echo RESOURCE_UNITS; ?></td>
		<?php }
    } ?>
	</tr>
	</table>
