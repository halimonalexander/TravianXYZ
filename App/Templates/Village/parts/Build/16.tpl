...
<a href=\"karte.php?d=".$enforce['from']."&c=".$generator->getMapCheck($enforce['from'])."\">".$this->database->getVillageField($enforce['from'],"name")."</a></td>
<td colspan=\"$colspan\">";
if (LANG == "es") {
                  echo "<a href=\"spieler.php?uid=".$this->database->getVillageField($enforce['from'],"owner")."\">".TROOPSFROM." ".$this->database->getUserField($this->database->getVillageField($enforce['from'],"owner"),"username",0)." </a>";
     }else{       echo "<a href=\"spieler.php?uid=".$this->database->getVillageField($enforce['from'],"owner")."\">".$this->database->getUserField($this->database->getVillageField($enforce['from'],"owner"),"username",0)." ".TROOPSFROM."</a>";
...
}else{              echo "<a href=\"spieler.php?uid=".$this->database->getVillageField($enforce['from'],"owner")."\">".$this->database->getUserField($this->database->getVillageField($enforce['from'],"owner"),"username",0)." ".TROOPSFROM."</a> ".FROM." <a href=\"karte.php?d=".$enforce['from']."&c=".$generator->getMapCheck($enforce['from'])."\">".$this->database->getVillageField($enforce['from'],"name")."</a>";
}
                    echo "</td></tr></thead><tbody class=\"units\">";
                    $tribe = $this->database->getUserField($this->database->getVillageField($enforce['from'],"owner"),"tribe",0);
                    $start = ($tribe-1)*10+1;
