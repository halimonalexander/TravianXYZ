...
function vil_levels_toggle(){
    ...
    dj.toggleClass('on');
    if (cj.hasClass('on')) {
        document.cookie = 't3l=1; expires=Wed, 1 Jan 2030 00:00:00 GMT';
    } else {
...
function gmwd() {
    if (is_ff2 && document.getElementById("gmwi").offsetWidth < 50) {
        document.cookie = "a3=2; expires=Wed, 1 Jan 2030 00:00:00 GMT";
    } else {
        document.cookie = "a3=1; expires=Wed, 1 Jan 2030 00:00:00 GMT";
    }
}

function gmc() {
    document.getElementById("gmw").style.display = "none";
    document.cookie = "a3=3; expires=Wed, 1 Jan 2030 00:00:00 GMT";
}
